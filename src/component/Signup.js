...
<div class="min-h-screen bg-gray-100 flex flex-col justify-center sm:py-12">
  <div class="p-10 xs:p-0 mx-auto md:w-full md:max-w-md">
    <h1 class="font-bold text-center text-2xl mb-5">Signup</h1>  
    <div class="bg-white shadow w-full rounded-lg divide-y divide-gray-200">
      <div class="px-5 py-7">
        ...
        <label class="font-semibold text-sm text-gray-600 pb-1 block">Password Confirmation</label>
        <input type="text" id="password_confirmation" class="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full"value={passwordConfirmation} onChange={(e) => setPasswordConfirmation(e.target.value)} />
